...
if __name__ == '__main__':
    trainMat = np.mat(loadDataSet(r'C:\Users\coc\Desktop\数据挖掘实习\实验5\bikeSpeedVsIq_train.txt'))
    testMat = np.mat(loadDataSet(r'C:\Users\coc\Desktop\数据挖掘实习\实验5\bikeSpeedVsIq_test.txt'))
